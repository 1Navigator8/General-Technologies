...
values
("Anna","Annina",2,"History",3),
("Laura","Cook",5,"Math",1),
("Ignasio","Duth",10,"X",4),
("Andry","Backetts",6,"Spanien",0),
("Tanja","Ansin",1,"Math",5),
("Valentina","Weber",3,"Geometry",5),
("Angela","Simpson",10,"X",3),
("Betina","Ivanova",4,"English",5),
("Maik","Uisli",8,"Math",5),
("Katja","Pushkin",7,"Science",5),
("Augusta","Ballentime",5,"Geomety",2),
("Tom","Lee",5,"English",0),
("Artem", "Vasilev", 9, "Math", 5);
...
-- символов.
select * from students where lastname like 'A%' and length(lastname) >2;
...
select * from students where subject="X" or (class>=7 and mark <3);
